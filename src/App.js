...
export default function App() {
  ...
  useEffect(
    function () {
      const controller = new AbortController(); // browzer API
...
function MovieDetails({ selectedID, onCloseMovie, onAddWatched, watched }) {
  ...
  // optional channel bec it might be there would be no movies in movie list
  ...
  useEffect(
    ...
    [selectedID] // as the selected id change, the effect would executed again
  );
  ...
  // we have introduced side effect in our effect below
